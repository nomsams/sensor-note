...
public class AudioFilterEngineTest {
    ...
    public void testLevelDb() {
        ...
        Assert.assertTrue("Full scale should be approximately -3 dB RMS", db > -6.0 && db <= 0.5);
        ...
        Assert.assertTrue("Half scale should be approximately -9 dB RMS", dbHalf > -12.0 && dbHalf < -3.0);
    }
